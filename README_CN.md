...
| 平台 | 状态 | 备注 |
|------|------|------|
| QQ | ✅ | 个人号、官方机器人（频道、私聊、群聊）、同时兼容 Matrix、Satori |
| 微信 | ✅ | 个人微信、微信公众号、Matrix、Satori |
| 企业微信 | ✅ | 应用消息、对外客服、智能机器人、Satori  |
| 飞书 | ✅ | 官方、同时兼容 Satori  |
| 钉钉 | ✅ | 官方、同时兼容 Satori |
| Satori | ✅ |  |
| Discord | ✅ | 官方、同时兼容 Matrix、Satori |
| Telegram | ✅ | 官方、同时兼容 Matrix、Satori |
