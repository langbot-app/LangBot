  ...
  const cards = [
    {
      ...
      trend: metrics?.trends ? { value: metrics.trends.messages, direction: metrics.trends.messages >= 0 ? 'up' : 'down' } : undefined,
    },
    {
      ...
      trend: metrics?.trends ? { value: metrics.trends.llmCalls, direction: metrics.trends.llmCalls >= 0 ? 'up' : 'down' } : undefined,
    },
    {
      ...
      trend: metrics?.trends ? { value: metrics.trends.successRate, direction: metrics.trends.successRate >= 0 ? 'up' : 'down' } : undefined,
    },
    {
      ...
      trend: metrics?.trends ? { value: metrics.trends.sessions, direction: metrics.trends.sessions >= 0 ? 'up' : 'down' } : undefined,
    },
  ];
