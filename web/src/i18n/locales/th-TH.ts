const thTH = {
  ...
  bots: {
    ...
    kuku: {
      title: 'KUKU สำหรับ Discord',
      description:
        'เปิดใช้งานและปรับแต่งการตั้งค่าการเริ่มบทสนทนาเชิงรุกของ KUKU สำหรับช่องข้อความ Discord',
      loadBootstrapError: 'โหลดข้อมูลการตั้งค่า KUKU ไม่สำเร็จ: ',
      loadSettings: 'โหลดการตั้งค่า',
      loadingSettings: 'กำลังโหลด...',
      loadSuccess: 'โหลดการตั้งค่า KUKU แล้ว',
      loadError: 'โหลดการตั้งค่า KUKU ไม่สำเร็จ: ',
      saveSuccess: 'บันทึกการตั้งค่า KUKU แล้ว',
      saveError: 'บันทึกการตั้งค่า KUKU ไม่สำเร็จ: ',
      saveSettings: 'บันทึกการตั้งค่า KUKU',
      groupId: 'Discord Channel ID',
      groupIdPlaceholder: 'วาง Discord text channel ID',
      groupIdRequired: 'จำเป็นต้องมี Discord channel ID',
      channelHint:
        'KUKU ใน MVP นี้รองรับเฉพาะ Discord ใช้ text channel ID เป็นขอบเขตของกลุ่ม แล้วโหลดการตั้งค่าที่มีอยู่หรือบันทึกการตั้งค่าใหม่',
      persona: 'บุคลิก',
      enabled: 'เปิดใช้งาน',
      enabledHint: 'อนุญาตให้ KUKU ส่งข้อความเชิงรุกในช่องนี้',
      silenceMinutes: 'นาทีที่เงียบ',
      cooldownMinutes: 'นาทีคูลดาวน์',
      quietHours: 'ช่วงเวลาเงียบ',
      quietHoursHint: 'ไม่บังคับ เว้นว่างไว้เพื่อปิดช่วงเวลาเงียบของช่องนี้',
      quietStart: 'เริ่ม',
      quietEnd: 'สิ้นสุด',
      timezone: 'เขตเวลา',
      loadedState: 'โหลดการตั้งค่า KUKU ที่บันทึกไว้สำหรับช่องนี้แล้ว',
      missingState:
        'ยังไม่มีการตั้งค่า KUKU ที่บันทึกไว้สำหรับช่องนี้ การบันทึกจะสร้างรายการใหม่',
      idleState:
        'กรอก Discord channel ID เพื่อโหลดการตั้งค่าที่มีอยู่หรือสร้างการตั้งค่าใหม่',
      notConfiguredYet: 'ยังไม่พบการตั้งค่า KUKU ที่บันทึกไว้สำหรับช่องนี้',
    },
    sessionMonitor: {
      title: 'เซสชัน',
      sessions: 'เซสชัน',
