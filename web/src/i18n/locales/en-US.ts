const enUS = {
  ...
  home: {
    title: 'Home',
    mounted: 'Home component mounted',
    unmounted: 'Home component unmounted',
  },
  sidebar: {
    mounted: 'Sidebar component mounted',
    unmounted: 'Sidebar component unmounted',
  },
  models: {
    title: 'Models',
    ...
    modelProviderDescription: 'Please fill in the model name provided by the supplier',
  },
  bots: {
    title: 'Bots',
  ...
  plugins: {
    title: 'Plugins',
    description: 'Install and configure plugins to extend LangBot functionality',
