...
# Legacy runner registry kept for provider runners awaiting plugin migration.
preregistered_runners: list[typing.Type[RequestRunner]] = []
# TODO(agent-runner): Remove this compatibility layer after the remaining
# provider runners are migrated to official AgentRunner plugins.
